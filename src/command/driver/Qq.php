...
namespace lmxdawn\oauth\command\driver;

use lmxdawn\oauth\command\Driver;
...
class Qq extends Driver
{
    ...
    const GET_AUTH_CODE_URL = BASE_URL ."/oauth2.0/authorize";//获取Authorization Code 地址
    const GET_ACCESS_TOKEN_URL = BASE_URL ."/oauth2.0/token";//获取Authorization Code获取Access Token
    const GET_OPENID_URL = BASE_URL ."/oauth2.0/me";//获取用户的openID
